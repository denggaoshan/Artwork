...
<body>
		...
		<form class="login" action="LoginAction.action" method="post" onsubmit="return check();">
			<ul>
				<li>
			...
			<p><a href="register.jsp" class="fl">注册账号</a> <a href="password.html" class="fr">忘记密码</a></p>
		</form>
