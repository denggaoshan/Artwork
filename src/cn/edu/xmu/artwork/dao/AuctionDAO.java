 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Auction
...
public class AuctionDAO extends BaseHibernateDAO {
	...
	public Auction findById(java.lang.String id) {
		...
		try {
			Auction instance = (Auction) getSession().get(
					"cn.edu.xmu.artwork.entity.Auction", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Auction instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.Auction")
