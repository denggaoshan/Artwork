...
import cn.edu.xmu.artwork.entity.Store;
 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Store
	...
	public Store findById(java.lang.String id) {
		...
		try {
			Store instance = (Store) getSession().get(
					"cn.edu.xmu.artwork.entity.Store", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Store instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.Store")
