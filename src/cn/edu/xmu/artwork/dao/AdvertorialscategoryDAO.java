...
import cn.edu.xmu.artwork.entity.Advertorialscategory;
 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Advertorialscategory
	...
	public Advertorialscategory findById(java.lang.String id) {
		...
		try {
			Advertorialscategory instance = (Advertorialscategory) getSession()
					.get("cn.edu.xmu.artwork.entity.Advertorialscategory", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Advertorialscategory instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"cn.edu.xmu.artwork.entity.Advertorialscategory")
