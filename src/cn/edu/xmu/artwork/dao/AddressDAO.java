...
import cn.edu.xmu.artwork.entity.Address;
 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Address
	...
	public Address findById(java.lang.String id) {
		...
		try {
			Address instance = (Address) getSession().get(
					"cn.edu.xmu.artwork.entity.Address", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Address instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.Address")
