...
import cn.edu.xmu.artwork.entity.Userlog;
 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Userlog
	...
	public List findByExample(Userlog instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.Userlog")
