...
import cn.edu.xmu.artwork.entity.Order;
 ...
 * 
 * @see cn.edu.xmu.artwork.entity.Order
	...
	public Order findById(java.lang.String id) {
		...
		try {
			Order instance = (Order) getSession().get(
					"cn.edu.xmu.artwork.entity.Order", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Order instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.Order")
