 ...
 * DatePosition entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see cn.edu.xmu.artwork.entity.DatePosition
...
/*
	public DatePosition findById(cn.edu.xmu.artwork.entity.DatePositionId id) {
		log.debug("getting DatePosition instance with id: " + id);
		try {
			DatePosition instance = (DatePosition) getSession().get(
					"cn.edu.xmu.artwork.entity.DatePosition", id);
			return instance;
		} catch (RuntimeException re) {
...
*/
	public List findByExample(DatePosition instance) {
		...
		try {
			List results = getSession()
					.createCriteria("cn.edu.xmu.artwork.entity.DatePosition")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding DatePosition instance with property: "
	...
	public DatePosition merge(DatePosition detachedInstance) {
		...
		try {
			DatePosition result = (DatePosition) getSession().merge(
					detachedInstance);
