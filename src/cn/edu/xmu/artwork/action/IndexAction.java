...
public class IndexAction extends ActionSupport {
	private static final long serialVersionUID = -1091333510677435160L;
	...
	public String execute() {
		...
		advertisementList = getInformationService().getTodayAdvertisementByPos(
				(short) 1);
		advertorialList = getInformationService().getTodayAdvertorialByPos(
				(short) 2);
	...
	public void setAdvertorialList(List<Advertorial> advertorialList) {
		this.advertorialList = advertorialList;
	}
}